...
module.exports = function(options) {
  var log = logger.createLogger('provider-ios')
  var workers = {}
 ...
 function trackDevices() {
  ...
  ioskit.trackDevices();
    ...
    events.on('add', filterDevice(function(device) {
    ...
    events.on('change', filterDevice(function(device) {
      flippedTracker.emit(device.id, 'change', device)
    }))

    events.on('remove', filterDevice(function(device) {
    ...
    lifecycle.share('Tracker', events)
 }
