...
program
  ...
  program
  .command('device-ios <serial>')
  .description('start device worker ios')
  .option('-n, --provider <name>'
    , 'provider name'
    , String)
  .option('-s, --connect-sub <endpoint>'
...
program
  ...
  .description('start app processor')
