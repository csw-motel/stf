...
var ios = require('./../units/provider-ios/ios.js')
var split = require('split')
var Promise = require('bluebird')
var devicedb =  require('stf-device-db')
...
devutil.makeIdentityIOS = function(serial) {
  return ios.makeIdentityIOS(serial);
}


devutil.getImeiIOS = function(serial) {
  return ios.getDeviceImei(serial)
}
